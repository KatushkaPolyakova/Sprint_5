...
class TestAuth:
    def test_registration(self, driver, new_email):
    ...
    def test_registration_invalid_email(self, driver, new_email):
    ...
    def test_registration_existing_user(self, driver, new_email):
        register(driver, new_email)
    ...
    def test_login(self, driver, new_email):
        register(driver, new_email)
    ...
    def test_logout(self, driver, new_email):
        register(driver, new_email)
